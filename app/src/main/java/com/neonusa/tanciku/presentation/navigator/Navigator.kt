...
import com.neonusa.tanciku.presentation.navigator.components.BottomNavigationBar
...
fun Navigator() {
    ...
    Scaffold(modifier = Modifier.fillMaxSize(), bottomBar = {
        ...
        NavHost(
            ...
            composable(route = Route.TransactionScreen.route) { backStackEntry ->
                Log.d("TEST", "Navigator: transaction screen")
            }
            composable(route = Route.HomeScreen.route) {
                Log.d("TEST", "Navigator: home screen")
            }
            composable(route = Route.SettingsScreen.route) {
                Log.d("TEST", "Navigator: settings screen")
